...
namespace MatcherMod.Modules
{
    internal static class Asset
    {
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            try
            {
                assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(MatcherPlugin.instance.Info.Location), "AssetBundles", bundleName));
            }
        ...
        internal static void LoadAssetBundleAsync(string bundleName, Action<AssetBundle> onComplete)
        {
            ...
            string path = Path.Combine(Path.GetDirectoryName(MatcherPlugin.instance.Info.Location), "AssetBundles", bundleName);
