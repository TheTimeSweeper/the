...
namespace KatamariMod.Modules
{
    internal static class RuntimeHelpers
    {
        public static void SetSkillFromFamily(this GenericSkill genericSkill, int index)
        {
            genericSkill.SetBaseSkill(genericSkill.skillFamily.variants[index].skillDef);
        } 
    }
    internal static class Assets
    {
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            AssetBundle assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(KatamariPlugin.instance.Info.Location), "AssetBundles", bundleName));
        ...
        internal static GameObject LoadAndAddProjectilePrefab(this AssetBundle assetBundle, string newPrefabName, bool registerNetwork = true)
        {
