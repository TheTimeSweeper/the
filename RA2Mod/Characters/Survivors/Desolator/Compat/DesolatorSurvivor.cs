    ...
    public class DesolatorSurvivor : SurvivorBase<DesolatorSurvivor>
    {
        ...
        private void InitializeSpecialSkills()
        {
            ...
            cancelDeploySkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                skillNameToken = TOKEN_PREFIX + "SPECIAL_DEPLOY_CANCEL_NAME",
                skillDescriptionToken = TOKEN_PREFIX + "SPECIAL_DEPLOY_CANCEL_DESCRIPTION",
                skillIcon = assetBundle.LoadAsset<Sprite>("texDesolatorSkillSpecialCancel"),
