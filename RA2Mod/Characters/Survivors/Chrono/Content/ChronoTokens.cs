...
namespace RA2Mod.Survivors.Chrono
{
    public static class ChronoTokens
    {
        ...
        public static void AddHenryTokens()
        {
            ...
            Language.Add(prefix + "NAME", "Chorno Legionnaire");
            ...
            Language.Add(prefix + "PRIMARY_SLASH_DESCRIPTION", Tokens.agilePrefix + $"Swing forward for <style=cIsDamage>{100f * ChronoStaticValues.swordDamageCoefficient}% damage</style>.");
            #endregion

            #region Secondary
            Language.Add(prefix + "SECONDARY_GUN_NAME", "Handgun");
            Language.Add(prefix + "SECONDARY_GUN_DESCRIPTION", Tokens.agilePrefix + $"Fire a handgun for <style=cIsDamage>{100f * ChronoStaticValues.gunDamageCoefficient}% damage</style>.");
            #endregion
            ...
            Language.Add(prefix + "SPECIAL_BOMB_DESCRIPTION", $"Throw a bomb for <style=cIsDamage>{100f * ChronoStaticValues.bombDamageCoefficient}% damage</style>.");
            #endregion
