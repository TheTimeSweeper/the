...
{
    public abstract class DependentChronoHuntressTracker : MonoBehaviour
    {
        public abstract DependentChronoHuntressTracker dependentTracker { get; set; }
        ...
        {
            if(dependentTracker != null && dependentTracker.GetTrackingTarget())
            {
                return dependentTracker.GetTrackingTarget();
            }
