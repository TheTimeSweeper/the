    ...
    internal static class Asset
    {
        ...
        public static GameObject LoadCrosshair(string crosshairName)
        {
            if (RoR2.LegacyResourcesAPI.Load<GameObject>("Prefabs/Crosshair/" + crosshairName + "Crosshair") == null) 
                return Asset.LoadAsset<GameObject>("Prefabs/Crosshair/StandardCrosshair");
        ...
        [Obsolete(obsolete)]
        public static Material CreateMaterial(string materialName) => Asset.CreateMaterial(materialName, 0f);
        [Obsolete(obsolete)]
        public static Material CreateMaterial(string materialName, float emission) => Asset.CreateMaterial(materialName, emission, Color.white);
        [Obsolete(obsolete)]
        public static Material CreateMaterial(string materialName, float emission, Color emissionColor) => Asset.CreateMaterial(materialName, emission, emissionColor, 0f);
        [Obsolete(obsolete)]
