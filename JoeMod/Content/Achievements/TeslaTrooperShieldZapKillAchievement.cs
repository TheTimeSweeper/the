...
namespace Modules.Achievements {
    public class TeslaTrooperShieldZapKillAchievement : GenericModdedUnlockable {

		public override string AchievementTokenPrefix => Survivors.TeslaTrooperSurvivor.TESLA_PREFIX + "SHIELDZAP";
		...
		public class TeslaTrooperShieldZapKillAchievementServer : BaseServerAchievement {
