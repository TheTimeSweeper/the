...
namespace JoeMod {
    public class TeslaTrackingConductiveResettingSkillDef : SkillDef {
        ...
        public float timeoutDuration = 1;
        public Sprite refreshedIcon;

        public override SkillDef.BaseSkillInstanceData OnAssigned([NotNull] GenericSkill skillSlot) {
            return new TeslaTrackingConductiveResettingSkillDef.InstanceData {
