...
namespace HenryMod.Modules.Achievements
{
    internal class MasteryAchievement : ModdedUnlockable
    {
        ...
        public override string AchievementNameToken { get; } = FacelessJoePlugin.developerPrefix + "_HENRY_BODY_MASTERYUNLOCKABLE_ACHIEVEMENT_NAME";
        ...
        public override Func<string> GetHowToUnlock { get; } = (() => Language.GetStringFormatted("UNLOCK_VIA_ACHIEVEMENT_FORMAT", new object[]
                            {
                                Language.GetString(FacelessJoePlugin.developerPrefix + "_HENRY_BODY_MASTERYUNLOCKABLE_ACHIEVEMENT_NAME"),
                                Language.GetString(FacelessJoePlugin.developerPrefix + "_HENRY_BODY_MASTERYUNLOCKABLE_ACHIEVEMENT_DESC")
                            }));
