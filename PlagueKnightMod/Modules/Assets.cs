...
namespace PlagueMod.Modules
{
    ...
    internal static class Assets
    {
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            AssetBundle assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(PlaguePlugin.instance.Info.Location), "AssetBundles", bundleName));
