...
using PlagueMod.Modules.Characters;
...
{
    public class PlagueSurvivor : SurvivorBase<PlagueSurvivor>
    {
        //todo guide
        //used to load the assetbundle for this character. make sure to rename this
        public override string assetBundleName => "plaguebundle";

        //the name of the prefab we will create. conventionally ending in "Body"
        public override string bodyName => "PlagueBody";

        //the names of the prefabs you set up in unity that we will use to build your character
        public override string modelPrefabName => "mdlPlague";
        public override string displayPrefabName => "PlagueDisplay";

        public const string PLAGUE_PREFIX = PlaguePlugin.DEVELOPER_PREFIX + "_PLAGUE_";
        ...
        public override ItemDisplaysBase itemDisplays => new PlagueItemDisplays();
        ...
        private void AddCasingSkills(GenericSkill casingSkill)
        {
            PlagueBombCasingSkillDef simpleCasingSkillDef = Skills.CreateSkillDef<PlagueBombCasingSkillDef>(new SkillDefInfo
            {
            ...
            Skills.AddSkillsToFamily(casingSkill.skillFamily, simpleCasingSkillDef, simpleCasingSkillDef2);
        }

        private void AddPowderSkills(GenericSkill powderSkill)
        {
            PlagueBombPowderSkillDef simplePowderSkillDef = Skills.CreateSkillDef<PlagueBombPowderSkillDef>(new SkillDefInfo
            {
            ...
            simplePowderSkillDef.projectileMaterial = assetBundle.LoadMaterial("gren");

            PlagueBombPowderSkillDef simplePowderSkillDef2 = Skills.CreateSkillDef<PlagueBombPowderSkillDef>(new SkillDefInfo
            {
            ...
            simplePowderSkillDef2.flyingState = new EntityStates.SerializableEntityStateType(typeof(Test2PowderSkillState));
            simplePowderSkillDef2.impactProjectilePrefab = PlagueAssets.SimpleImpactPowderProjectile2;
            simplePowderSkillDef2.projectileMaterial = assetBundle.LoadMaterial("red");

            Skills.AddSkillsToFamily(powderSkill.skillFamily, simplePowderSkillDef, simplePowderSkillDef2);
        }
        #endregion skills
        ...
        public override void InitializeCharacterMaster()
        {
            ...
            Modules.Prefabs.CloneDopplegangerMaster(bodyPrefab, "PlagueMonsterMaster", "Merc");
